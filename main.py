...
while running:
    ...
    if Game_over:
        ...
        update_bullet(bullets, bricks) #move the bullets in bullets Group upwards or kill the bullet and brick if they are collide with each other
        update_brick(bricks, bullets) #move the bricks in bricks Group downwards or kill it if drops on the ground
